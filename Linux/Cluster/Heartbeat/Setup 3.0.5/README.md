...
[root@localhost ~]# yum install -y bzip2 autoconf automake libtool libtool-ltdl-devel \
glib2-devel libxml2 libxml2-devel bzip2-devel e2fsprogs-devel libxslt-devel \
libtool-ltdl-devel make wget docbook-dtds docbook-style-xsl bzip2-devel asciidoc libuuid-devel
...
[root@localhost Heartbeat-3-0-958e11be8686]# ./configure --prefix=/usr/local/heartbeat
#若出现如下警告：
...
[root@localhost Heartbeat-3-0-958e11be8686]# vim lib/hbclient/Makefile
#将其中所有的-Werror删除
